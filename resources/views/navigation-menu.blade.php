        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Remplacez les liens individuels par ce dropdown -->
                    @if(auth()->user()->role->wording === 'admin')
                        <div class="ml-3 mt-2 relative">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <span class="inline-flex rounded-md">
                                        <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-800 bg-gray-300 hover:text-gray-800 focus:outline-none focus:bg-gray-250 active:bg-gray-250 transition ease-in-out duration-150">
