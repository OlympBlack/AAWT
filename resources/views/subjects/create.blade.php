                    ...
                    <div class="mb-4">
                        ...
                        <select id="classroom_id" name="classroom_id"
                            ...
                            @foreach ($classrooms as $classroom)
                                <option value="{{ $classroom->id }}">{{ $classroom->wording }}
                                    {{ $classroom->serie->wording }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-4">
